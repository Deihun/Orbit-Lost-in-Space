...
func setHappy():
	$Reaction.texture = load("res://Resources/CREW/CrewLobby/Maxim/Maxim Lobby_Happy.png")

func setAngry(): 
	$Reaction.texture = load("res://Resources/CREW/CrewLobby/Maxim/Maxim Lobby_Angry.png")

func setNeutral(): 
	$Reaction.texture = load("res://Resources/CREW/CrewLobby/Maxim/Maxim Lobby_Neutral.png")
