...
func setHappy():
	$Reaction.texture = load("res://Resources/CREW/CrewLobby/Regina/Regina Lobby_Happy.png")

func setAngry(): 
	$Reaction.texture = load("res://Resources/CREW/CrewLobby/Regina/Regina Lobby_Angry.png")

func setNeutral(): 
	$Reaction.texture = load("res://Resources/CREW/CrewLobby/Regina/Regina Lobby_neutral.png")
