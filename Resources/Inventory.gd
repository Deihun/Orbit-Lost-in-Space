...
func add_fuel(item_name : String, Value : int = 3):
	var battery = {
		"name" : item_name,
		"type" : "fuel",
		"value": Value,
...
func add_food(item_name : String, food_amount : int, is_sealed : bool, expiration_countdown_per_cycle : int, expiration_total : int):
	var food = {
		"name" : item_name, 
		"type" : "food",
